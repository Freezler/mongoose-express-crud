...
// this line is to set the views directory so that we can use ejs files and __ dirname gives the path of the current directory
...
// this line is to use method override
...
app.put('/products/:id', async (req, res) => {
  console.log(req.body);npm install method-override
  res.send('PUT!')
})
